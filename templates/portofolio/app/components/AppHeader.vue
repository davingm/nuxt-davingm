...
<template>
  <header class="sticky top-0 z-40 w-full border-b border-neutral-200 dark:border-neutral-800 bg-white/80 dark:bg-[#121212]/80 backdrop-blur-md transition-colors">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 h-14 flex items-center justify-between gap-4">
      ...
      <NuxtLink
        to="/"
        class="flex items-center gap-2.5 group font-medium text-neutral-900 dark:text-neutral-100"
      >
        ...
        <span class="font-semibold tracking-tight text-sm sm:text-base">
          davin<span class="text-neutral-400 dark:text-neutral-500 font-normal">.dev</span>
        </span>
      ...
      <!-- Center: Desktop Nav (VitePress style) -->
      ...
      <!-- Right: Search, Socials, Theme Toggle, Mobile Button -->
    ...
    <div
      v-if="mobileMenuOpen"
      class="md:hidden border-t border-neutral-200 dark:border-neutral-800 bg-white dark:bg-[#181818] px-4 py-3 space-y-1 shadow-lg"
    >
      <NuxtLink
        v-for="link in navLinks"
        :key="link.to"
      ...
      <div class="pt-2 border-t border-neutral-100 dark:border-neutral-800 flex items-center justify-between text-xs text-neutral-500">
        ...
        <div class="flex items-center gap-3">
          <a href="https://github.com/davingm" target="_blank" class="hover:text-neutral-900 dark:hover:text-white">GitHub</a>
          <a href="https://x.com/davingm" target="_blank" class="hover:text-neutral-900 dark:hover:text-white">X / Twitter</a>
        </div>
      </div>
    </div>
  </header>
